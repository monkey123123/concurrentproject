...
@Slf4j
@Component
public class StandaloneProcessorDemo2 implements BasicProcessor {
    ...
    public ProcessResult process(TaskContext context) throws Exception {
        ...
        System.out.println("----------------------- StandaloneProcessorDemo2#process ------------------------");
        System.out.println(context.getJobParams());
        // 根据控制台参数判断是否成功
        boolean success = !"failed".equals(context.getJobParams());
        omsLogger.info("StandaloneProcessorDemo2 finished process,success: .", success);
