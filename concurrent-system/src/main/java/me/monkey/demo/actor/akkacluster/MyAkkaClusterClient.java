package me.monkey.demo.actor.akkacluster;
...
import static me.monkey.demo.actor.akkacluster.TransformationMessages.BACKEND_REGISTRATION;
...
public class MyAkkaClusterClient extends UntypedActor {
    ...
    public void onReceive(Object message) {
        ...
        } else if (Integer.parseInt(message.toString()) == BACKEND_REGISTRATION) {
            /**
             * 注册服务提供者
             */
    ...
    public static void main(String [] args){
        ...
        ActorSystem actorSystem = ActorSystem.create("akkaClusterTest", ConfigFactory.load("akkacluster-client.conf"));
